 ...
 * @author matth
 */
public class PanelFacturaGuia extends javax.swing.JPanel {

    MainController mainCon = new MainController();
    javax.swing.JPanel cambioPanel = null;
    
    public PanelFacturaGuia() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jButton2.setText("Descargar Y Ver Factura");
        ...
        jButton3.setText("Descargar Y Ver Guia");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        cambioPanel = mainCon.getPanelVerGuia();
        mainCon.getMain().getvMain().cambiarPaneles(cambioPanel);
    }//GEN-LAST:event_jButton3ActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        cambioPanel = mainCon.getPanelVerFactura();
        mainCon.getMain().getvMain().cambiarPaneles(cambioPanel);
